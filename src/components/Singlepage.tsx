...
export function BlogJourneyPage() {
  ...
  <div className="min-h-screen bg-background p-6 flex justify-center">
      <div className="max-w-3xl bg-background bg-card border border-border shadow-lg rounded-2xl p-8">
...
export function BlogTypeScriptPage() {
  return (
     <div className="min-h-screen bg-background p-6 flex justify-center">
      <div className="max-w-3xl bg-background  border border-border shadow-lg rounded-2xl p-8">
